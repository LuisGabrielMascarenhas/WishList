...
public class MainActivity extends AppCompatActivity {
    ...
    private void updateProduto() {
        ...
        String valor = String.valueOf(Float.parseFloat(editTextValor.getText().toString()));

        int rating = (int) ratingBar.getRating();

        if (TextUtils.isEmpty(nome)) {
            editTextNome.setError("Por favor, insira o n    ome");
            editTextNome.requestFocus();
            return;
        }
        if (TextUtils.isEmpty(valor)) {
            editTextValor.setError("Insira o valor");
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            txtViewUpdate.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    editTextValor.setText(String.valueOf(wish.getValor()));
                ...
                public void onClick(View view) {
                    ...
                    builder.setTitle("Apagar " + wish.getNome())
                            ...
                            .setNegativeButton(android.R.string.no, new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialogInterface, int which) {
                                    // Faça algo se o usuário optar por não excluir
                                }
                            })
